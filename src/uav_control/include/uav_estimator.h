...
class UAV_estimator
{
    public:
        ...
        ros::Subscriber RTK_land_global_position_sub;
        ...
        ros::Publisher RTK_land_local_position_pub;
    ...
    private:
        ...
        void set_RTK_land_pose_cb(const sensor_msgs::NavSatFix::ConstPtr &msg);
