...
public:
    ...
    ros::Subscriber rtk_land_local_position_sub;
    ...
    bool set_init_RTK_hoverPos; //使用RTK时使用init悬停点
    ...
    Eigen::Vector3d RTK_des_position;
    double RTK_des_yaw;
...
private:
    ...
    void set_rtk_land_pos_cb(const geometry_msgs::PoseStamped::ConstPtr &msg);
